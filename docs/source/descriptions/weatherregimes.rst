...
.. code-block:: R
  ...
  ## Plotting Weather regimes of the model with colours and contours
#save as pdf
#fname.pdf="output_graphics.pdf"
#pdf(file=fname,width=14,height=7)
#save as eps
fname.ps="output_graphics.eps"
postscript(file=fname,width=1400,height=700)
# colorscale 
